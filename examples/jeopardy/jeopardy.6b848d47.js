...
})({"aJIqg":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "4a236f9275d0a351";
module.bundle.HMR_BUNDLE_ID = "95d0ddf36b848d47";
"use strict";
...
},{}],"k41VS":[function(require,module,exports) {
...
var _maybe = require("../derw-packages/derw-lang/stdlib/src/Maybe");
var _dict = require("../derw-packages/derw-lang/stdlib/src/Dict");
...
const initModel = _dict.fromList(_list.map(function(index) {
    return {
        key: index,
        value: Unread({
        })
...
function update(msg, model) {
    ...
    switch(_res.kind){
        case "SetCorrect":
            {
                const { value  } = _res;
                return _dict.update(value, function(x) {
                    return _maybe.map(justCorrect, x);
                }, model);
            }
        case "SetIncorrect":
            {
                const { value  } = _res;
                return _dict.update(value, function(x) {
                    return _maybe.map(justIncorrect, x);
                }, model);
            }
        case "SetUnread":
            {
                const { value  } = _res;
                return _dict.update(value, function(x) {
                    return _maybe.map(justUnread, x);
                }, model);
            }
    }
}
...
function makeRectangle(answer) {
    return _html.div([], [
        _html.style_("width", "140px"),
        _html.style_("height", "100px"),
        _html.style_("margin-top", "10px"),
        _html.style_("padding-top", "5px"),
        _html.style_("padding-left", "5px"),
        _html.style_("background-color", getColor(answer.value)),
        _html.style_("border", "2px solid black")
    ], [
        _html.button([
...
function stats(model) {
    const correct = _string.fromNumber(_list.length(_list.filter(isCorrect, _dict.values(model))));
    const incorrect = _string.fromNumber(_list.length(_list.filter(isIncorrect, _dict.values(model))));
    const unread = _string.fromNumber(_list.length(_list.filter(isUnread, _dict.values(model))));
    return _html.text(" Correct: " + correct + " | Incorrect: " + incorrect + " | Unread: " + unread);
}
function view(model) {
    return _html.div([], [
        _html.style_("padding", "10px")
    ], [
        _html.h3([], [], [
            _html.text("Jeopardy! Heatmap")
        ]),
        _html.p([], [
            _html.style_("font-size", "12px")
        ], [
            _html.text("this is by msszczep on Github, rewritten in Derw as an example of Derw")
        ]),
        _html.p([], [], [
            _html.a([], [
                _html.attribute("href", "http://www.szcz.org/jeopardyheatmap.html")
            ], [
                _html.text("Original is here.")
            ])
        ]),
        _html.p([], [], [
            _html.a([], [
                _html.attribute("href", "https://github.com/msszczep/jeopardy-heatmap/")
            ], [
                _html.text("Copy of Elm source code is here.")
            ])
        ]),
        _html.p([], [], [
            _html.a([], [
                _html.attribute("href", "https://github.com/derw-lang/examples/")
            ], [
                _html.text("Copy of Derw source code is here.")
            ])
        ]),
        _html.p([], [], [
            stats(model)
        ...
        _html.div([], [
            _html.style_("display", "grid"),
            _html.style_("grid-template-columns", "auto auto auto auto auto auto"),
            _html.style_("padding", "10px"),
            _html.style_("width", "80%")
        ], _list.map(makeRectangle, _dict.toList(model)))
    ]);
}
...
},{"../derw-packages/derw-lang/html/src/Html":"kOGU7","../derw-packages/derw-lang/stdlib/src/String":"54tQw","../derw-packages/derw-lang/stdlib/src/List":"aTN6x","../derw-packages/derw-lang/stdlib/src/Maybe":"gVibC","../derw-packages/derw-lang/stdlib/src/Dict":"jaOii"}],"kOGU7":[function(require,module,exports) {
...
},{"@eeue56/coed":"iyhoP","@parcel/transformer-js/src/esmodule-helpers.js":"luhAv"}],"iyhoP":[function(require,module,exports) {
"use strict";
...
},{"@eeue56/ts-core":"6Qdlt"}],"6Qdlt":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./lib/basics":"kMjpg","./lib/debug":"98MV9","./lib/maybe":"a67gg","./lib/result":"f6nVx","./lib/tuple":"7YF6B","@parcel/transformer-js/src/esmodule-helpers.js":"luhAv"}],"kMjpg":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"luhAv"}],"luhAv":[function(require,module,exports) {
...
},{}],"98MV9":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
/*
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"luhAv"}],"a67gg":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
/*
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"luhAv"}],"f6nVx":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
/*
Creates an Ok value
...
},{"./maybe":"a67gg","@parcel/transformer-js/src/esmodule-helpers.js":"luhAv"}],"7YF6B":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
/*
Create a new tuple
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"luhAv"}],"54tQw":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"luhAv"}],"aTN6x":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
var _listKernel = require("./List_kernel");
const emptyList = [];
function map(fn, xs) {
    return xs.map(fn);
}
...
function length(xs) {
    return _listKernel.kernelLength(xs);
}

},{"./List_kernel":"ldHe1","@parcel/transformer-js/src/esmodule-helpers.js":"luhAv"}],"ldHe1":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "kernelLength", ()=>kernelLength
);
function kernelLength(xs) {
    return xs.length;
}

},{"@parcel/transformer-js/src/esmodule-helpers.js":"luhAv"}],"gVibC":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "Just", ()=>Just
);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"luhAv"}],"jaOii":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
var _maybe = require("./Maybe");
var _dictKernel = require("./Dict_kernel");
function get(key, dict) {
    const value = dict[key];
    if (value === undefined) return _maybe.Nothing({
    });
    else return _maybe.Just({
        value
    });
}
function update(a, fn, dict) {
    return _dictKernel.kernelUpdate(a, fn, dict);
}
...
function fromList(items) {
    return _dictKernel.kernelFromList(items);
}
function toList(dict) {
    return _dictKernel.kernelToList(dict);
}

},{"./Maybe":"gVibC","./Dict_kernel":"gj1rr","@parcel/transformer-js/src/esmodule-helpers.js":"luhAv"}],"gj1rr":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "kernelUpdate", ()=>kernelUpdate
);
parcelHelpers.export(exports, "kernelFromList", ()=>kernelFromList
);
parcelHelpers.export(exports, "kernelToList", ()=>kernelToList
);
var _maybe = require("./Maybe");
function kernelUpdate(a, fn, dict) {
    let updated = _maybe.Nothing({
    });
    if (Object.keys(dict).indexOf(a) === -1) updated = fn(_maybe.Nothing({
    }));
    else updated = fn(_maybe.Just({
        value: dict[a]
    }));
    if (updated.kind === "Nothing") {
        const newDict = {
        };
        for (const key of Object.keys(newDict))if (key !== a) newDict[key] = dict[key];
        return newDict;
    }
    const newDict = {
        ...dict
...
function kernelFromList(items) {
    ...
    for (const item of items)obj[item.key] = item.value;
    return obj;
}
function kernelToList(dict) {
    const items = [];
    for (const key of Object.keys(dict))items.push({
        key,
        value: dict[key]
    });
    return items;
...
},{"./Maybe":"gVibC","@parcel/transformer-js/src/esmodule-helpers.js":"luhAv"}]},["aJIqg","k41VS"], "k41VS", "parcelRequire7479")

//# sourceMappingURL=jeopardy.6b848d47.js.map
